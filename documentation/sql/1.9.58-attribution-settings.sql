...
ALTER TABLE `1ai_attribution_settings`
...
CREATE UNIQUE INDEX IF NOT EXISTS `user_scope_model`
    ON `1ai_attribution_settings` (`user_id`, `scope_type`, `scope_id`, `model_id`);

CREATE UNIQUE INDEX IF NOT EXISTS `user_scope_multi_touch`
    ON `1ai_attribution_settings` (`user_id`, `scope_type`, `scope_id`, `multi_touch_enabled`);

UPDATE `1ai_attribution_settings`
