# 1ai-Affiliate Tokens

One of the poweful features of 1ai-Affiliate Pro is the ability to use a whole variaty of tokens as dynamic placeholders. This tokens can be used on almost any type of link place in 1ai-Affiliate Pro. This includes:

All pixel and postback urls in Step 1
Your campaign tracking links in Step 3
Your Simple Landing Page Url

Here's a full list of 1ai-Affiliate Tokens

**[[subid]]** - The subid is the most important token for most users, and is automatically generated by 1ai-Affiliate Pro. This is a unique click id generated on each click, that must usually be passed in your campaign tracking link in order to ensure accurate tracking of conversions
...
**[[payout]]** - The payout amount of the offer. This is pulled from the payout you set in [step 3](../setting-up-1ai-affiliate-pro/04-step-3.md).

**[[cpc]]** - The cpc for the click, it comes from the cpc value you setup on [step 8](../setting-up-1ai-affiliate-pro/09-step-8.md) when generating your tracking link. This value is rounded up to 2 decimal points

**[[cpc2]]** - The cpc for the click, it comes from the cpc value you setup on [step 8](../setting-up-1ai-affiliate-pro/09-step-8.md) when generating your tracking link. This value is not rounded, and is ideal for ppv values
