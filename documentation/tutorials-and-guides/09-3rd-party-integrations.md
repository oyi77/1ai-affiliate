...
Currently inside your 1ai-Affiliate Install, we support a number of 3rd party integrations available to you. Below are the three integrations you will find:

## Direct Network Integration

Direct Network Integration allows you to quickly find and setup offers directly inside of 1ai-Affiliate without any manual work. You can review the section on Direct Network Integrations for more details about this. [Click here to go there now](10-direct-network-integrations-dni.md).
...
**Video:** [Setting Up 1ai-Affiliate and Clickbank Instant Notification](https://www.youtube.com/watch?v=M6zo3XuExL0&feature=youtu.be)

## Slack Integration

If you love using Slack and use it often as part of your workflow, then you might want to integrate Prosper into Slack. Our team uses Slack and we thought what could we do to help improve the process. By integrating 1ai-Affiliate into Slack, it will enable you to know exactly what every team member does in 1ai-Affiliate as soon as it happens? These notifications could then trigger a meaningful conversation.
...
Step 3: Go to the My Account menu in 1ai-Affiliate Pro and select 3rd Party API Integrations
...
Step 5: There is no step 5. Start receiving real time 1ai-Affiliate Pro notifications sent to your Slack
