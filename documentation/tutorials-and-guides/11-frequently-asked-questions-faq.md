...
## What is 1ai-Affiliate?

1ai-Affiliate is analytics tracking software that enables users to track profit and loss, conversion metrics, do split testing, and much more. We can track almost any traffic source and pretty much any affiliate offer/network/advertiser. We are not an affiliate network software nor are we a media server. 1ai-Affiliate was specifically designed to help people track their marketing campaigns and how well it's doing. Whether you are an affiliate, a small business owner, an agency, a product owner, etc.. we can help. Unsure if 1ai-Affiliate is right for you, feel free to contact us and ask.

 ## What is the difference between Tracking202 and 1ai-Affiliate?

Tracking202 was our hosted solution for our flagship analytics tracking software and 1ai-Affiliate is the self-hosted solution. They are essentially the same thing.

 ## Can I use shared hosting to install 1ai-Affiliate?

As a general rule of thumb, we do not recommend using shared hosting to run your 1ai-Affiliate. Most shared hosting services do not meet the requirements of installing 1ai-Affiliate and even if you could get it to work, we highly recommend against it for performance reasons.

There are many affordable VPS or better hosting solutions, and we always strongly recommend using those instead.

 ## Will 1ai-Affiliate Work With My Web Host?

There is no way for us to tell specifically as there are too many web hosts out there for us to know of or even check. In general, most web hosts can be configured or install software to make it work, but by default, it is difficult to tell. If you want to be certain, please check our list of recommended web hosting companies who already support current 1ai-Affiliate users: [Web Hosting Services](../partnering-with-us/01-web-hosting-services.md)

 ## I am having issues with installing or upgrading 1ai-Affiliate or some other technical issue
...
Please go to Overview > Group Overview and see if that's what you're looking for. Please also note that there are additional filter options most people miss. Please explore all parts of Prosper before contacting us about this. If you've tried to look everywhere and your data is still missing, we can help troubleshoot but you'll need to be on a paid support plan.
 ...
 ## Are there any limitations with the free 1ai-Affiliate?
...
Without knowing what you did or how you set up your campaign, we can not answer this question easily. You can review over our tutorial videos to see if you set everything up correctly or sign up for a support plan and contact us for further assistance.
 ...
 ## Does 1ai-Affiliate offer cloaking?

At the time of this writing, we do not. 

 ## Does your analytics software work with email marketing or actual mobile apps?

We've had users use our software for email marketing, and while our software works with promoting mobile install offers, it does not yet support event tracking inside of mobile apps. Please note that 1ai-Affiliate was not designed for mobile app install tracking.

 ## Can 1ai-Affiliate filter out IP ranges?
...
Clicks are tracked when someone clicks on your ad. CTR is tracked when someone clicks from your LP to the offer.
 ...
 ## Does 1ai-Affiliate offer URL shortening
...
If you know how to do this manually through your DB, you can do it but the option is not built into 1ai-Affiliate yet.
