# 1ai-Affiliate Release Cycle

We recently implemented a change on how new releases work at 1ai-Affiliate.

Whenever you download 1ai-Affiliate from our site, that will be the latest free version available. Whether you're an existing user or new user, this will be the case. If you are a new user and you just installed 1ai-Affiliate, you might be confused as to why there is an upgrade message right when you log in and why it is asking you for a 1ai-Affiliate Customer API Key. Please read **[Step 0](01-step-0.md)** to better understand what the API key is for and what you need to do to get that activated.
