...
You will need a [web host](../partnering-with-us/01-web-hosting-services.md) in order to install 1ai-Affiliate. We highly recommend getting at least VPS hosting as some shared hosting services do not work well with 1ai-Affiliate. If you need recommendations for a web host to install 1ai-Affiliate, we recommend these hosting companies [here](../partnering-with-us/01-web-hosting-services.md).

Our installer was inspired by the WordPress installer, and we have made it almost exactly the same as theirs. It can generally be installed in about 5 minutes or less by simply uploading the files to a dedicated domain and then running the installer. The following installation guide will help you install 1ai-Affiliate.

Before you begin the install, there are few things you need to check, have, and do.

## System Requirements

Below is a sample screenshot of what you'll need with your hosting company to install 1ai-Affiliate:
...
2. A text editor.
3. An FTP Client (if you need to install 1ai-Affiliate on a remote server).
...
**Video:** [1ai-Affiliate Tutorial - How To Install 1ai-Affiliate 1.8.3](https://www.youtube.com/watch?v=Qbb8k0F3SjA&feature=youtu.be)
