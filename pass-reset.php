...
if ($success == true) {
	...
	_die("<center><small>Congratulations, your password has been reset.<br/>You can now <a href=\"" . get_absolute_url() . "login.php\">login</a> with your new password.</small></center>");
}

if (!empty($error['user_pass_key'])) {

	_die("<center><small>" . $error['user_pass_key'] . "<br/>Please use the <a href=\"" . get_absolute_url() . "lost-pass.php\">password retrieval tool</a> to get a new password reset key.</small></center>");
}
