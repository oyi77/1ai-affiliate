/**
 * Attribution Analytics - Sandbox Modal Functionality
 * Handles the sandbox modal for model comparison and promotion.
...
(function (window, document) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function renderComparisons(payload) {
            ...
            payload.models.forEach(function (model) {
                ...
                if (metrics && metrics.totals) {
                    hasMetrics = true;
                    revenueCell.textContent = window.Attribution.formatCurrency(metrics.totals.revenue);
                    conversionsCell.textContent = window.Attribution.formatNumber(metrics.totals.conversions);
                    roiCell.textContent = window.Attribution.formatPercent(metrics.totals.roi);
                } else {
        ...
        function ensureModelsLoaded() {
            ...
            return window.Attribution.fetchJson(apiBase + '/models').then(function (payload) {
        ...
        function promoteSelectedModel() {
            ...
            window.Attribution.fetchJson(apiBase + '/models/' + targetModel.model_id, {
                method: 'PATCH',
                headers: {
        ...
        function runSandboxComparison() {
            ...
            var range = window.Attribution.getUnixHourRange(24);
        ...
        function trapFocus(event) {
            ...
            var focusable = window.Attribution.getFocusableElements(dialog);
