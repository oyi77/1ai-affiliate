...
header("Content-Disposition: attachment; filename=Tplatforms_".time().".xls");
...
$data=($de->getReportData('platform', $mysql['from'], $mysql['to'],$cpv));

$dr= new DisplayData();
$dr->downloadReport('platform', $data, $de->foundRows());
