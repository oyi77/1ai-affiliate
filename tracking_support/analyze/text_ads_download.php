...
header("Content-Disposition: attachment; filename=Ttext_ads_".time().".xls");
...
$data=($de->getReportData('textad', $mysql['from'], $mysql['to'],$cpv));

$dr= new DisplayData();
$dr->downloadReport('textad', $data, $de->foundRows());
