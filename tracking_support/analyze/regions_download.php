...
header("Content-Disposition: attachment; filename=Tregions_".time().".xls");
...
$data=($de->getReportData('region', $mysql['from'], $mysql['to'],$cpv));

$dr= new DisplayData();
$dr->downloadReport('region', $data, $de->foundRows());
