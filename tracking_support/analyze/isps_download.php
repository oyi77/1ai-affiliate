...
header("Content-Disposition: attachment; filename=Tisps_" . time() . ".xls");
...
$data = ($de->getReportData('isp', $mysql['from'], $mysql['to'], $cpv));

$dr = new DisplayData();
$dr->downloadReport('isp', $data, $de->foundRows());
