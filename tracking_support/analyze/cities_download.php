...
header("Content-Disposition: attachment; filename=Tcities_" . time() . ".xls");
...
$data = ($de->getReportData('city', $mysql['from'], $mysql['to'], $cpv));

$dr = new DisplayData();
$dr->downloadReport('city', $data, $de->foundRows());
