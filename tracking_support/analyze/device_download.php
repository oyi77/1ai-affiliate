...
header("Content-Disposition: attachment; filename=Tdevices_".time().".xls");
...
$data=($de->getReportData('device', $mysql['from'], $mysql['to'],$cpv));

$dr= new DisplayData();
$dr->downloadReport('device', $data, $de->foundRows());
