...
<?php display_calendar(get_absolute_url().'tracking_support/ajax/sort_hourly.php', true, true, true, false, true, true); ?>    

<script type="text/javascript">
   loadContent('<?php echo get_absolute_url();?>tracking_support/ajax/sort_hourly.php',null);
</script>
