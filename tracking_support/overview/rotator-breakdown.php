...
<?php display_calendar(get_absolute_url().'tracking_support/ajax/sort_rotator.php', true, false, true, false, true, true, true); ?> 
    
<script type="text/javascript">
   loadContent('<?php echo get_absolute_url();?>tracking_support/ajax/sort_rotator.php',null);
</script>
