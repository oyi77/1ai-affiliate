...
$tracker_sql = "
	...
	FROM
		clicks, clicks_record, clicks_site, site_urls, aff_campaigns,users_pref
	WHERE
		clicks.aff_campaign_id = aff_campaigns.aff_campaign_id
		AND users_pref.user_id = 1
		AND clicks.click_id = clicks_record.click_id
		AND clicks_record.click_id_public='".$mysql['click_id_public']."'
		AND clicks_record.click_id = clicks_site.click_id 
		AND clicks_site.click_redirect_site_url_id = site_urls.site_url_id
";
...
if (!$tracker_row) {
	...
	$action_site_url = "/tracking_support/redirect/cl2.php";
