...
$info_sql = "
	SELECT
		...
		aff_campaign_payout
	FROM
		aff_campaigns AS 2ac,
		clicks_record AS 2cr
		LEFT JOIN clicks AS 2c ON (2c.click_id = 2cr.click_id)
		LEFT JOIN clicks_site AS 2cs ON (2cs.click_id = 2cr.click_id)
	WHERE
