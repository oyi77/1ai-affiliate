...
include_once(substr(__DIR__, 0,-17) . '/config/connect.php');
	...
	//the pixel
	$pixel = '<img height="1" width="1" border="0" style="display: none;" src="http://'.$host.get_absolute_url().'tracking_support/static/px.php?acip='.$html['aff_campaign_id_public'].'"/>';

	//post back url
	$postback = 'http://'.$host.get_absolute_url().'tracking_support/static/pb.php?acip='.$html['aff_campaign_id_public'].'&subid=';
