...
include_once(substr(__DIR__, 0, -17) . '/config/ReportSummaryForm.class.php');
...
<div class="row">
	...
	<div class="col-xs-4 text-right" style="margin-top:15px;">
		...
		<a style="font-size:12px;" target="_new" href="<?php echo get_absolute_url(); ?>tracking_support/overview/group_overview_download.php">
