	...
	<div class="col-xs-12" style="margin-top: 10px;">
		<table class="table table-bordered" id="stats-table">
			...
			<tbody>
				...
				?>
					...
					<tr style="background-color: #F8F8F8;" class="no-sort">
						...
						<td><span class="label label-<?php if ($net > 0) {
															echo 'primary';
														} elseif ($net < 0) {
															echo 'important';
														} else {
															echo 'default';
														} ?>"><?php echo $html['rotator_net']; ?></span></td>
						<td><span class="label label-<?php if ($net > 0) {
															echo 'primary';
														} elseif ($net < 0) {
															echo 'important';
															...
															echo 'default';
														} ?>"><?php echo $html['rotator_roi']; ?></span></td>
					...
					<tr>
						...
						<td><span class="label label-<?php if ($rule_net > 0) {
															echo 'primary';
														} elseif ($rule_net < 0) {
															echo 'important';
														} else {
															echo 'default';
														} ?>"><?php echo $html['rule_net']; ?></span></td>
						<td><span class="label label-<?php if ($rule_net > 0) {
															echo 'primary';
														} elseif ($rule_net < 0) {
															echo 'important';
															...
															echo 'default';
														} ?>"><?php echo $html['rule_roi']; ?></span></td>
					</tr>
				...
				<tr class="no-sort">
					...
					<td><span class="label label-<?php if ($default_net > 0) {
														echo 'primary';
													} elseif ($default_net < 0) {
														echo 'important';
													} else {
														echo 'default';
													} ?>"><?php echo $html['default_net']; ?></span></td>
					<td><span class="label label-<?php if ($default_net > 0) {
														echo 'primary';
													} elseif ($default_net < 0) {
														echo 'important';
														...
														echo 'default';
													} ?>"><?php echo $html['default_roi']; ?></span></td>
				</tr>
				</tr>
			<?php } ?>
			...
			<tr style="background-color: #F8F8F8;" id="totals" class="no-sort">
				...
				<td><span class="label label-<?php if ($total_net > 0) {
													echo 'primary';
												} elseif ($total_net < 0) {
													echo 'important';
												} else {
													echo 'default';
												} ?>"><?php echo $html['total_net']; ?></span></td>
				<td><span class="label label-<?php if ($total_net > 0) {
													echo 'primary';
												} elseif ($total_net < 0) {
													echo 'important';
													...
													echo 'default';
												} ?>"><?php echo $html['total_roi']; ?></span></td>
			</tr>
