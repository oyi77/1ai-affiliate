...
//show tracking code
	...
	$affiliate_link = '//' . getTrackingDomain() . get_absolute_url().'tracking_support/redirect/go.php?lpip=' . $landing_page_row['landing_page_id_public'];
	...
	$affiliate_link = '//' . getTrackingDomain() . get_absolute_url().'tracking_support/redirect/lp.php?lpip=' . $landing_page_row['landing_page_id_public'];
	$html['affiliate_link'] = htmlentities($affiliate_link);
