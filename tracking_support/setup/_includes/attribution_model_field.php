...
try {
    ...
    require_once dirname(__DIR__, 3) . '/config/Attribution/Repository/Mysql/MysqlModelRepository.php';
    require_once dirname(__DIR__, 3) . '/config/Attribution/AttributionIntegrationService.php';
    ...
    <div class="col-xs-6">
        ...
        <small class="help-block">
            <?php if ($defaultModelId): ?>
                ...
                <a href="<?php echo get_absolute_url(); ?>tracking_support/setup/attribution_models.php" target="_blank">
                    Manage Models
                </a>
            <?php else: ?>
