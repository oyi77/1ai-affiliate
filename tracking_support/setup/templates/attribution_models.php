            ...
            <div class="row">
                ...
                <div class="form-group" style="margin-top: 25px; padding-top: 20px; border-top: 1px solid #ecf0f1;">
                    <div class="hidden-xs">
                        ...
                        <a href="<?php echo get_absolute_url(); ?>tracking_support/setup/attribution_models.php" class="btn btn-default btn-lg" style="margin-left: 10px;">
                    ...
                    <div class="visible-xs">
                        ...
                        <a href="<?php echo get_absolute_url(); ?>tracking_support/setup/attribution_models.php" class="btn btn-default btn-block btn-lg">
                            <span class="glyphicon glyphicon-remove"></span>
                            Cancel
                        </a>
                    </div>
