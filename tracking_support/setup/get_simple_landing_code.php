...
<div class="row" style="margin-bottom: 24px;">
	<div class="col-xs-12">
		<div class="lp-tabs">
			<a href="<?php echo get_absolute_url();?>tracking_support/setup/get_simple_landing_code.php" class="lp-tab active">
			...
			<a href="<?php echo get_absolute_url();?>tracking_support/setup/get_adv_landing_code.php" class="lp-tab">
				<div class="lp-tab-icon">
