...
require_once dirname(__DIR__, 2) . '/config/Attribution/ModelType.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/ModelDefinition.php';

// Repository interfaces
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/ModelRepositoryInterface.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/SnapshotRepositoryInterface.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/TouchpointRepositoryInterface.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/ConversionRepositoryInterface.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/AuditRepositoryInterface.php';

// MySQL implementations
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/Mysql/MysqlModelRepository.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/Mysql/MysqlSnapshotRepository.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/Mysql/MysqlTouchpointRepository.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/Mysql/MysqlConversionRepository.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/Mysql/MysqlAuditRepository.php';

// Null implementations
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/NullModelRepository.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/NullSnapshotRepository.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/NullTouchpointRepository.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/NullConversionRepository.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/Repository/NullAuditRepository.php';

// Services
require_once dirname(__DIR__, 2) . '/config/Attribution/AttributionJobRunner.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/AttributionService.php';
require_once dirname(__DIR__, 2) . '/config/Attribution/AttributionServiceFactory.php';

// Validation
require_once dirname(__DIR__, 2) . '/config/Validation/ValidationResult.php';
require_once dirname(__DIR__, 2) . '/config/Validation/ValidationException.php';
require_once dirname(__DIR__, 2) . '/config/Validation/SetupFormValidator.php';
...
class AttributionController extends SetupController
{
    ...
    private function saveModel(): void
    {
        ...
        $this->redirect('tracking_support/setup/attribution_models.php');
    }
