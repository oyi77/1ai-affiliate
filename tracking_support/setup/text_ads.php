...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($editing == true) {
		...
		$ad_varation_sql = "SELECT 
							...
							text_ads.text_ad_name AS text_ad_name,
							text_ads.text_ad_headline AS text_ad_headline,
							text_ads.text_ad_description AS text_ad_description,
							text_ads.text_ad_display_url AS text_ad_display_url,
	...
	if (!$error) { 
		...
		if ($editing == true) {
			...
			header('location: '.get_absolute_url().'tracking_support/setup/text_ads.php');   
