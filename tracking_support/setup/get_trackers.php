...
if ($showEdit) {
	$edit_tracker_sql = "SELECT * FROM trackers AS 2tr
						 LEFT JOIN landing_pages AS 2lp ON (2tr.landing_page_id = 2lp.landing_page_id)
						 LEFT JOIN aff_campaigns AS 2ac ON (2tr.aff_campaign_id = 2ac.aff_campaign_id)
				...
				<div id="filterTrackers">
					...
					<ul class="list setup-list">
						...
						$trackers_sql = "SELECT 
					                 ...
					                 LEFT JOIN landing_pages AS 2lp ON (2tr.landing_page_id = 2lp.landing_page_id) 
                                     LEFT JOIN aff_campaigns AS 2ac ON (2tr.aff_campaign_id = 2ac.aff_campaign_id)
                                     LEFT JOIN rotators AS 2r ON (2tr.rotator_id = 2r.id)
                                     LEFT JOIN ppc_accounts AS 2ppc ON (2tr.ppc_account_id = 2ppc.ppc_account_id)
