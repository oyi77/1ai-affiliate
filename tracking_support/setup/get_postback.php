...
//the pixels
$unSecuredPixel = '<img height="1" width="1" border="0" style="display: none;" src="http://'. getTrackingDomain() .get_absolute_url().'tracking_support/static/gpx.php?amount=&subid=" />';
$unSecuredPixel_2 = '<img height="1" width="1" border="0" style="display: none;" src="http://'. getTrackingDomain() .get_absolute_url().'tracking_support/static/gpx.php?amount=&cid=&subid=" />';

//post back urls
$unSecuredPostBackUrl = 'http://'. getTrackingDomain() .get_absolute_url().'tracking_support/static/gpb.php?amount=&subid=';
$unSecuredPostBackUrl_2 = 'http://'. getTrackingDomain() .get_absolute_url().'tracking_support/static/gpb.php?amount=&subid=';

//universal pixel
$unSecuredUniversalPixel = '<iframe height="1" width="1" border="0" style="display: none;" frameborder="0" scrolling="no" src="http://'. getTrackingDomain() .get_absolute_url().'tracking_support/static/upx.php?amount=&subid=" seamless></iframe>';
...
<script>
 var vars202={amount:"",cid:"",subid:""};(function(d, s) {
 	...
 	load("http://'. getTrackingDomain() .get_absolute_url().'tracking_support/static/upx.php?amount="+vars202[\'amount\']+"&cid="+vars202[\'cid\']+"&subid="+vars202[\'subid\'], "upxif");
 }(document, "script"));</script>
<noscript>
 	<iframe height="1" width="1" border="0" style="display: none;" frameborder="0" scrolling="no" src="http://'. getTrackingDomain() .get_absolute_url().'tracking_support/static/upx.php?amount=&cid=&subid=" seamless></iframe>
</noscript>';
