					...
					<tbody>
						...
						?>
								<tr>
									...
									<td><a href="<?php echo get_absolute_url(); ?>account/api-integrations.php?edit_dni_network=<?php echo $dni_row['id']; ?>"><i class="glyphicon glyphicon-pencil"></i></a> <a href="<?php echo get_absolute_url(); ?>account/api-integrations.php?delete_dni_network=<?php echo $dni_row['id']; ?>" onClick="return confirm('Delete This DNI Network?')"><i class="glyphicon glyphicon-trash"></i></a></td>
								</tr>
						<?php }
						} ?>
					</tbody>
...
<div class="row account">
	<div class="col-xs-12">
		<div class="row">
			<div class="col-xs-4">
				<h6><span><img src="<?php echo get_absolute_url(); ?>img/icons/integrations/ipqs.png"></span> IPQualityScore Integration <?php showHelp("jvzoo"); ?></h6>
			</div>
			<div class="col-xs-8">
...
<div class="row account">
	<div class="col-xs-12">
		<div class="row">
			<div class="col-xs-4">
				<h6><span><img src="<?php echo get_absolute_url(); ?>img/icons/integrations/jvzoo.png"></span> JVZoo JVZIPN <?php showHelp("jvzoo"); ?></h6>
			</div>
			<div class="col-xs-8">
		...
		<div class="row">
			...
			<form class="form-horizontal" role="form" method="post" action="">
				...
				<div class="col-xs-9">
					...
					<small>
						<em><?php echo $strProtocol . '' . getTrackingDomain() . get_absolute_url() . 'tracking_support/static/jvzoo.php'; ?></em>
					</small>
...
<div class="row account">
	<div class="col-xs-12">
		<div class="row">
			<div class="col-xs-4">
				<h6><span><img src="<?php echo get_absolute_url(); ?>img/icons/integrations/zaxaa.png"></span> ZPN Payment Notification (ZPN) <?php showHelp("zaxaa"); ?></h6>
			</div>
			<div class="col-xs-8">
		...
		<div class="row">
			...
			<form class="form-horizontal" role="form" method="post" action="">
				...
				<div class="col-xs-9">
					...
					<small>
						<em><?php echo $strProtocol . '' . getTrackingDomain() . get_absolute_url() . 'tracking_support/static/zpn.php'; ?></em>
					</small>
		...
		<div class="row">
			...
			<form class="form-horizontal" role="form" method="post" action="">
				...
				<div class="col-xs-9">
					...
					<small>
						<em><?php echo $strProtocol . '' . getTrackingDomain() . get_absolute_url() . 'tracking_support/static/slack.php'; ?></em>
					</small>
...
<div class="row account">
	<div class="col-xs-12">
		<div class="row">
			<div class="col-xs-4">
				<h6><span><img src="<?php echo get_absolute_url(); ?>img/icons/integrations/paykickstart.png"></span> PayKickstart Affiliate IPN <?php showHelp("paykickstart"); ?></h6>
			</div>
			<div class="col-xs-8">
		...
		<div class="row">
			...
			<form class="form-horizontal" role="form" method="post" action="">
				...
				<div class="col-xs-9">
					...
					<small>
						<em><?php echo $strProtocol . '' . getTrackingDomain() . get_absolute_url() . 'tracking_support/static/paykickstart.php'; ?></em>
					</small>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function getDNIProgress(DNIdata) {
				$.post("<?php echo get_absolute_url(); ?>account/ajax/dni.php?getProgress=true", DNIdata).done(function(response) {
					var json = $.parseJSON(response);
					$.each(json.data, function(index, item) {
						if (item.progress == '100') {
							$.post("<?php echo get_absolute_url(); ?>account/ajax/dni.php?updateStatus=true&dni=" + item.id, function(data1) {
