		...
		<div class="panel panel-default">
			...
			<div id="collapseOne" class="panel-collapse collapse <?php if ($_SESSION['show_update_check'] == true) echo "in"; ?>" role="tabpanel" aria-labelledby="headingOne">
				<div class="panel-body">
					<small>
						<p>Your /config/ directory is not writable or PHP zip extension is disabled.</p>
					</small>
					<small>
...
<?php } else if ($_SESSION['update_needed'] == true) { ?>
	...
	<div id="changelogs" class="modal fade" role="dialog">
		...
		<div class="panel-group alertaccordion" id="accordion" role="tablist" aria-multiselectable="true">
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingOne">
					<h4 class="panel-title">
						<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
							<?php echo $_SESSION['premium_pdetails']['headline']; ?>
						</a>
						<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="float:right">&times;</a>
					</h4>
				</div>
				<div id="collapseOne" class="panel-collapse collapse <?php if ($_SESSION['show_update_check'] == true) echo "in"; ?>" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body" id="noKeyBody">
						<small>
							<p><?php echo $_SESSION['premium_pdetails']['body']; ?></p>
						</small>
						<small>
							<p>Release date: <?php echo $_SESSION['premium_pdetails']['release-date']; ?> - <a href="#changelogs" id="see_changelogs" data-toggle="modal" data-target="#changelogsPremium" style="color:#428bca; font-weight:normal; margin-top: 15px;">See what's new</a></p>
						</small>
						<small>
						...
						<small>
							<p>You can access your API key on "Personal Settings"</p>
						</small>
					</div>
				</div>
			</div>
			...
			<div class="panel panel-default">
				...
				<div id="collapseOne" class="panel-collapse collapse <?php if ($_SESSION['show_update_check'] == true) echo "in"; ?>" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						...
						<a style="margin-right:5px;" href="<?php echo get_absolute_url(); ?>account/auto-upgrade-premium.php" class="btn btn-xs btn-warning"><?php echo $_SESSION['premium_pdetails']['order-button-text']; ?> ($<?php echo $_SESSION['premium_pdetails']['upgrade-price']; ?>)</a>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$('.alertaccordion').on('hidden.bs.collapse', function() {
		$.post("<?php echo get_absolute_url(); ?>account/ajax/delay-alert.php", {
			delay: true
		});
	});
</script>