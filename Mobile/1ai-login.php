...
include_once(substr(__DIR__, 0, -11) . '/config/connect.php');

$error = [];
$html = [];

if (AUTH::logged_in()) {
	header('location: ' . get_absolute_url() . 'Mobile/mini-stats');
}
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$log_stmt = $db->prepare('INSERT INTO users_log (user_name, user_pass, ip_address, login_time, login_success, login_error, login_server, login_session) VALUES (?, ?, ?, ?, ?, ?, ?, ?)');
	if ($log_stmt) {
...
<body>
	...
	<div class="center">
		...
		<table cellspacing="0" cellpadding="5">
			<tr>
				<td colspan="2" style="text-align: center;"><a href="https://my.tracking1ai.com" target="_blank"><img src="<?php echo get_absolute_url(); ?>img/oneai_affiliate.png" /></a><br /></td>
			</tr>
			<tr>
				<td>
						...
						<table cellspacing="0" cellpadding="5" style="margin: 0px auto;">
							...
							<tr>
								...
								<td>
									...
									<!-- <span id="forgot_pass"><br>(<a href="<?php echo get_absolute_url(); ?>lost-pass.php">I forgot my password/username</a>)</a> -->
								</td>
							</tr>
							<tr>
