...
include_once(str_repeat("../", 1) . 'config/functions-auth.php');
...
try {
    ...
    $log_sql = "SELECT last_execution_time FROM cronjob_logs WHERE id = 1";
    ...
    $de_sql = "SELECT COUNT(*) as total, SUM(processed) as done FROM dataengine_job";
