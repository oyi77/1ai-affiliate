...
$exportDirectory = __DIR__ . '/../config/temp/attribution-exports';
...
function buildWebhookDownloadUrl(ExportJob $job): ?string
{
    ...
    $path = '/account/attribution/download.php';
...
{
    $timestamp = time();
    $connection->query('REPLACE INTO cronjob_logs (id, last_execution_time) VALUES (3, ' . $timestamp . ')');
}
