 ...
 * Example (quarter-hour cadence): 0,15,30,45 * * * * /usr/bin/php /path/to/oneai_affiliate/cronjobs/sync-dashboard-data.php
 */
...
include_once(str_repeat("../", 1) . 'config/DashboardAPI.class.php');
include_once(str_repeat("../", 1) . 'config/DashboardDataManager.class.php');
