...
<div class="row home">
  <div class="col-xs-12">
  	<h4><img src="<?php echo get_absolute_url();?>img/new/icons/building.svg" alt="ribbon" class="tile-hot-ribbon"> 1ai-Affiliate App Store - 1-Click Install Apps & Services</h4>
