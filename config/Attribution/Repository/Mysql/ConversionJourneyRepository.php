...
SQL;
    ...
    private function insertJourney(int $conversionId, array $journey): void
    {
        ...
        $sql = <<<SQL
INSERT INTO conversion_touchpoints (conv_id, click_id, click_time, position, created_at)
VALUES (?, ?, ?, ?, ?)
SQL;
    ...
    {
        $stmt = $this->conn->prepareWrite('DELETE FROM conversion_touchpoints WHERE conv_id = ?');
    ...
    private function fetchConversions(
        ...
        if ($scopeType === ScopeType::ADVERTISER) {
            ...
            $sql .= ' INNER JOIN aff_campaigns ac ON cl.campaign_id = ac.aff_campaign_id';
        }
