...
final class MysqlTrackingRepository implements TrackingRepositoryInterface
{
    ...
    public function findOrCreateKeyword(string $name): int
    {
        ...
        return $this->findOrCreateSimple('keywords', 'keyword_id', 'keyword', $name);
    }
    ...
    public function findOrCreateC1(string $value): int
    {
        ...
        return $this->findOrCreateSimple('clicks_c1', 'c1_id', 'c1', $value);
    }
    ...
    public function findOrCreateC2(string $value): int
    {
        ...
        return $this->findOrCreateSimple('clicks_c2', 'c2_id', 'c2', $value);
    }
    ...
    public function findOrCreateC3(string $value): int
    {
        ...
        return $this->findOrCreateSimple('clicks_c3', 'c3_id', 'c3', $value);
    }
    ...
    public function findOrCreateC4(string $value): int
    {
        ...
        return $this->findOrCreateSimple('clicks_c4', 'c4_id', 'c4', $value);
    }
    ...
    public function findOrCreateVariable(string $value, int $ppcVariableId): int
    {
        ...
        $stmt = $this->conn->prepareRead(
            'SELECT custom_variable_id FROM custom_variables WHERE ppc_variable_id = ? AND variable = ?'
        );
        ...
        $stmt = $this->conn->prepareWrite(
            'INSERT INTO custom_variables SET ppc_variable_id = ?, variable = ?'
        );
        $this->conn->bind($stmt, 'is', [$ppcVariableId, $value]);
    ...
    {
        $stmt = $this->conn->prepareRead(
            'SELECT variable_set_id FROM variable_sets WHERE variables = ?'
        );
        ...
        $stmt = $this->conn->prepareWrite(
            'INSERT INTO variable_sets SET variables = ?'
        );
        $this->conn->bind($stmt, 's', [$variables]);
