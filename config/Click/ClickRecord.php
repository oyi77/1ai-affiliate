...
final class ClickRecord
{
    ...
    // Tracking data (clicks_tracking)
    public int $c1Id = 0;
    public int $c2Id = 0;
    public int $c3Id = 0;
    public int $c4Id = 0;

    // Variable data (clicks_variable)
    public int $variableSetId = 0;

    // Google/UTM data (google)
    public string $gclid = '';
