...
function _die($message): never
{
	...
	info_top();
	echo '<div class="main col-xs-7"><center><img src="' . get_absolute_url() . 'img/oneai_affiliate.png"></center>';
	echo $message;
	echo '</div>';
	info_bottom();
	die();
...
function is_installed(): bool
{
	...
	if (str_contains((string) $_SERVER['PHP_SELF'], 'config/get_apikey.php')) {
		return false;
	}
...
?>
	...
	<head>
		...
		<link rel="shortcut icon" href="../img/favicon.gif" type="image/ico" />
		<!-- Loading Bootstrap -->
		<link
			href="<?php echo get_absolute_url(); ?>css/css/bootstrap.min.css"
			rel="stylesheet" />
		<!-- Loading Flat UI -->
		<link
		...
		<script type='text/javascript'>
			googletag.cmd.push(function() {
				googletag.defineSlot("/1006305/P1AI_CS_Login_Page_288x200", [288, 200], "div-gpt-ad-1398648278789-0").addService(googletag.pubads());
...
<?php }
	...
	function check_premium_update()
	{
		...
		if ((version_compare($version, $array['version']) == '-1')) {
			...
			$_SESSION['premium_pdetails'] = $array;
